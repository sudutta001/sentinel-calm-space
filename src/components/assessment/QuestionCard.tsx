...
interface QuestionCardProps { question: AssessmentQuestion; number: number; total: number; options: LikertOption[]; value?: LikertValue; onChange: (value: LikertValue) => void; }
